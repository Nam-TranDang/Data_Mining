...
#-----------------------------------------------------------------------
# File    : chkacc.py
# Contents: check of accretion variants
# Author  : Christian Borgelt
# History : 2013.??.?? file created
...
if __name__ == '__main__':
    ...
    for p,f in [('accretion', accretion),
        ...
        pypats = [(tuple(sorted(list(p[0]))), p[1]) for p in pypats]
        expats = [(tuple(sorted(list(p[0]))), p[1]) for p in expats]
