...
{                               /* --- prepare reporter for eclat */
  ...
  if (eclat->mode & ECL_ZLIB)   /* if the compression flag is set, */
  ...
  n = (eclat->mode & ECL_PREFMT)/* get range of numbers to preformat */
...
{                               /* --- main function */
  ...
  #endif  /* #ifndef QUIET */
  /* free option characters: [A-Z]\[ACFINPRSTZ] */
